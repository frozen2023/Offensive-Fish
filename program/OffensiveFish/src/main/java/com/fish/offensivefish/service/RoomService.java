...
public interface RoomService {
    ...
    public Map<String,Object> entryRoom(String code,String playerId);//进入房间，进入后房间人数自增1
    public Map<String,Object> ExitRoom(int roomId,String userId);//退出房间，退出后房间人数减一，此时房间可以进入
